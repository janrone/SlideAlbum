package com.janrone.app.slidealbum.slideshow;
...
import com.janrone.app.slidealbum.slideshow.playlist.RandomPlayList;
import com.janrone.app.slidealbum.slideshow.playlist.SequentialPlayList;
import com.janrone.app.slidealbum.slideshow.transition.BaseTransitionFactory;
import com.janrone.app.slidealbum.slideshow.transition.FadeTransitionFactory;
import com.janrone.app.slidealbum.slideshow.transition.FlipTransitionFactory;
import com.janrone.app.slidealbum.slideshow.transition.NoTransitionFactory;
import com.janrone.app.slidealbum.slideshow.transition.RandomTransitionFactory;
import com.janrone.app.slidealbum.slideshow.transition.SlideAndZoomTransitionFactory;
import com.janrone.app.slidealbum.slideshow.transition.ZoomTransitionFactory;

import static com.janrone.app.slidealbum.slideshow.SlideShowAdapter.SlideStatus;
...
public class SlideShowView extends RelativeLayout implements View.OnClickListener {
    ...
    private void readAttributeSet(Context context, AttributeSet attrs, int defStyle) {
        ...
        long transitionDuration = a.getInteger(R.styleable.SlideShowView_transitionDuration, (int) BaseTransitionFactory.DEFAULT_DURATION);
